...
There are many walks along the Great Ouse of varying lengths, sights and ease of access. The longest is the Ouse Valley Way.
...
<img class="rounded card-img-top" src="./assets/images/grow.png" alt="syresham to buckingham">
...
[The Navigable River: Bedford to Earith](#the-navigable-river-bedford-to-earith)
...
In this part we'll be spending time following the streams, brooks and ditches and walking through fields with the occasional sight of a hare or deer but usually accompanied by the sound of blackbirds, great tits and skylarks.
...
<img src="./assets/images/1/pub%20in%20Syresham.jpg" class="rounded card-img-top" alt="...">

Unfortunately, the route is a little bit confusing at the start and not all the landowners help to keep the paths clear. Following the road to Biddlesden is not a bad way to start.

<div class="row">
<div class="col-6">
<img class="rounded card-img-top" src="./assets/images/1/Start%20of%20Great%20Ouse%20Way.jpg" alt="syresham to buckingham">
</div>
<div class="col-6">
<img src="./assets/images/1/path%20obscured%20to%20Dadford 2.jpg" class="rounded card-img-top" alt="...">
</div>
</div>
...
<div class="row">
<div class="col-6">
<img class="rounded card-img-top" src="./assets/images/1/lake%20by%20path%20to%20Stowe.jpg" alt="syresham to buckingham">
</div>
<div class="col-6">
<img src="./assets/images/1/sheep%20on%20queens%20drive%20at%20Stowe.jpg" class="rounded card-img-top" alt="...">
</div>
</div>

<img src="./assets/images/1/Corinthian%20Arch%20at%20Stowe.jpg" class="rounded card-img-top" alt="...">

From Stowe it's a pleasant wander down Stowe Avenue, shaded by majestic beeches, down to the gate houses that demark the estate from the town. 

<img src="./assets/images/1/Stowe%20Avenue%202.jpg" class="rounded card-img-top" alt="...">
...
<img class="rounded card-img-top" src="./assets/images/2.png" alt="syresham to buckingham to stony">
...
<div class="row">
<div class="col-6">
<img class="rounded card-img-top" src="./assets/images/1/Buckingham%20canal.jpg" alt="syresham to buckingham">
</div>
<div class="col-6">
<img src="./assets/images/1/Great%20Ouse%20from%20Buckingham.jpg" class="rounded card-img-top" alt="...">
</div>
</div>

Much of the route to up to Thornton follows the old canal and it's worth noting the different species of plant that grow in the old canal bed.
<img src="./assets/images/1/plants%20growing%20in%20former%20canal%20at%20Thornton.jpg" class="rounded card-img-top" alt="...">

There are a couple of issues with the route, particularly beyond Thornton, which have been [marked on the map](#interactive-map). 
...
<img class="rounded card-img-top" src="./assets/images/4.png" alt="NP Olney">
...
#### 5. Olney to Odell (13 km)

<img class="rounded card-img-top" src="./assets/images/5.png" alt="Olney Odell">
...
where the Great Ouse marks the border.

<img src="./assets/images/1/turvey_border.jpg" class="rounded card-img-top" alt="...">

Turvey is a pleasant village, despite having to manage a fair weight of passing traffic, and a good place to get provisions.
...
It's also where we join another walking route, the [John Bunyan](https://en.wikipedia.org/wiki/John_Bunyan) Trail. The author of Pilgrim's Progress used to walk about these parts as a tinker before his religious calling when he swapped mending pots and pans for giving sermons.
...
The constant flow of water to the river takes on a different significance at Stevington. Here you might see people who have come from miles away to fill up bottles of water from a holy well which passes under St Mary's church (and graveyard).
...
This pleasant stroll starts by walking through [Priory Country Park](https://www.bedford.gov.uk/leisure-parks-and-sport/parks-and-open-spaces/parks-bedford-borough/priory-country-park) which was developed after the gravel pits were decommissioned.
...
<img class="rounded card-img-top" src="./assets/images/2/bedford_cambridge_railway.jpg" alt="Pavenham to Bedford">
...
<div class="row">
<div class="col-6">
<img src="./assets/images/2/grange.jpg" class="rounded card-img-top" alt="...">
</div>
<div class="col-6">
<img src="./assets/images/2/dovecote.jpg" class="rounded card-img-top" alt="...">
</div>
</div>
...
<div class="row">
<div class="col-6">
<img src="./assets/images/2/new_gravel.jpg" class="rounded card-img-top" alt="...">
</div>
<div class="col-6">
<img src="./assets/images/2/new_gravel_2.jpg" class="rounded card-img-top" alt="...">
</div>
</div>
...
<div class="row">
<div class="col-6">
<img src="./assets/images/2/new_gravel_3.jpg" class="rounded card-img-top" alt="...">
</div>
<div class="col-6">
<img src="./assets/images/2/new_gravel_4.jpg" class="rounded card-img-top" alt="...">
</div>
</div>
...
<div class="row">
<div class="col-6">
<img src="./assets/images/2/great_ouse_willington.jpg" class="rounded card-img-top" alt="...">
</div>
<div class="col-6">
<img src="./assets/images/2/great_barford.jpg" class="rounded card-img-top" alt="...">
</div>
</div>
...
From Roxton, the character of the walk changes dramatically. The route leaves being the river and much of its timelessness to witness a very different view of England.
...
Major developments are underway in this area with new road and rail infrastructure along with a substantial increase in housing.
...
There are some attractive parts of the walk into Wyboston which can feel like a quiet village.
...
However, at the eastern end of the village, the noise of traffic increases as we reach the A1.
...
The route continues along the A1 until it reaches Eaton Socon, where we rejoin the Great Ouse.
...
From this point on, the trail is in pretty good shape with good signage and other resources, thanks in large part to the [Great Ouse Valley Trust](https://greatousevalleytrust.org.uk/ouse-valley-way/).
...
There are also other trails worth a diversion.
...
Not all of the way to Godmanchester is as accessible as it could be.
...
The East Coast Mainline railway runs parallel to the river and increasing makes its presence felt until you're close enough to do some trainspotting. On the far side are the twin villages of Offord Cluny and Offord d'Arcy which each has a church that looks big enough for both - but one has been topped with a spire. Any previous sibling rivalry is now a thing of the past as only one has remained a church.
